...
1. [01 System Overview](01_system_overview.md) - the business flow from Typeform to Pipedrive, calendars, WhatsApp, Zoom, and reminders.
2. [02 Automation Reference](02_automation_reference.md) - every live Windmill automation, trigger, schedule, and worker.
3. [03 Integration Setup](03_integration_setup.md) - external accounts, webhook URLs, Windmill variables, and credential ownership.
4. [04 Operations Runbook](04_operations_runbook.md) - how to test, monitor, troubleshoot, and safely deploy changes.
5. [05 Pipedrive Activity Audit Standard](05_pipedrive_activity_audit_standard.md) - how Pipedrive activities are used as both operational tasks and automation audit logs.
...
- This local folder is not currently a git repo, so durable code history should be set up before broader team edits.
